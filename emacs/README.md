...
[init-elpa.el](file:///home/dclee/.dotfiles/emacs/lisp/init-elpa.el) 配置：
...
| `gc-cons-threshold` | 启动时放大到 128MB，启动后恢复 20MB（[init.el:27-31](file:///home/dclee/.dotfiles/emacs/init.el#L27-L31)） |
| `use-package-always-defer` | 延迟加载非核心包（[init.el:46](file:///home/dclee/.dotfiles/emacs/init.el#L46)） |
