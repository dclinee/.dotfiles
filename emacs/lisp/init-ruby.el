...

;;; bundler 包已从 MELPA 移除，改用 project-relative 文件查找
;; (require-package 'bundler)  ; 已废弃

;; 如果需要 bundler 功能，可用以下方式替代：
;; (use-package bundler :ensure nil :load-path "path/to/local/bundler")
