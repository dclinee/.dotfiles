...
nnoremap <silent><buffer> <Leader>ca :CocAction<CR>           " 代码操作
nnoremap <silent><buffer> <Leader>cr :CocCommand rust-analyzer.run<CR>  " 运行
nnoremap <silent><buffer> <Leader>cd :CocCommand rust-analyzer.debug<CR> " 调试
nnoremap <silent><buffer> <Leader>ce :CocCommand rust-analyzer.expandMacro<CR> " 展开宏
nnoremap <silent><buffer> <Leader>cg :CocCommand rust-analyzer.parentModule<CR> " 跳转到父模块
nnoremap <silent><buffer> <Leader>cm :CocCommand rust-analyzer.moveItem<CR>  " 移动项
